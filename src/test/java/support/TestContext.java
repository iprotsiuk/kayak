...
public class TestContext {
    ...
    public static String getResourcesPath(String folder, String name){
        String path = System.getProperty("user.dir") + "/src/test/resources/" + folder +"/" + name;
        return path;
    }
    ...
    public static HashMap<String, String> getUser() throws Exception {
        return getData("user");
    }
